...
public class AgroOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agro_order);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(AgroOrderActivity.this, "Please input text!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(AgroOrderActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(AgroOrderActivity.this, "No Order Found!", Toast.LENGTH_SHORT).show();
                finish();
        ...
        ListAdapter adapter = new SimpleAdapter(
                AgroOrderActivity.this, list, R.layout.order_list_items,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AgroOrderActivity.this, OrderDetailsActivity.class);
