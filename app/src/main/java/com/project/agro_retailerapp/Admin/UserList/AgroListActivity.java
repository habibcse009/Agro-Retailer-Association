...
public class AgroListActivity extends AppCompatActivity {
    ListView CustomList;
    Button btnSearch;
    EditText etxtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Agro Farm List");
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (searchText.isEmpty()) {
                    Toasty.error(AgroListActivity.this, "Please input agro farm name!", Toast.LENGTH_SHORT).show();
                } else {
                    getData(searchText);
                }
            }
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toasty.error(AgroListActivity.this, "Network Error!", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toasty.error(AgroListActivity.this, "No Agro Farm Found!", Toast.LENGTH_SHORT).show();
        ...
        ListAdapter adapter = new SimpleAdapter(
                AgroListActivity.this, list, R.layout.agro_list_item,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                new AlertDialog.Builder(AgroListActivity.this)
                        //.setMessage("Want to Call this Shop Now?")
                        .setMessage("Choose about this Agro Farm")
                        .setCancelable(false)
                        ...
                        .setNegativeButton("Delete User", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //write here
                                new androidx.appcompat.app.AlertDialog.Builder(AgroListActivity.this)
                                        .setMessage("Want to delete Agro Farm?")
                                        .setCancelable(false)
    ...
    public void deleteUser(final String id) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (getResponse.equals("success")) {
                            ...
                            Intent intent = new Intent(AgroListActivity.this, AdminMainActivity.class);
                            Toasty.success(AgroListActivity.this, " Deleted !", Toast.LENGTH_SHORT).show();
                        ...
                        //If we are getting success from server
                            ...
                            Toast.makeText(AgroListActivity.this, "Delete fail!", Toast.LENGTH_SHORT).show();
                            //startActivity(intent);

                        } else {

                            loading.dismiss();
                            Toast.makeText(AgroListActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(AgroListActivity.this, "No Internet Connection or \nThere is an error !!!", Toast.LENGTH_LONG).show();
                        loading.dismiss();
                    }
                }) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AgroListActivity.this);
        requestQueue.add(stringRequest);
